...
/* build-hook-start *//*00001*/try { require('/Users/vedthampi/.vscode/extensions/wallabyjs.console-ninja-1.0.454/out/buildHook/index.js').default({tool: 'webpack', checkSum: '20bc8a53152d5e8b9d0779V00BWBsKC1ECVlRSWwZdVwAAVFsE', mode: 'build'}); } catch(cjsError) { try { import('file:///Users/vedthampi/.vscode/extensions/wallabyjs.console-ninja-1.0.454/out/buildHook/index.js').then(m => m.default.default({tool: 'webpack', checkSum: '20bc8a53152d5e8b9d0779V00BWBsKC1ECVlRSWwZdVwAAVFsE', mode: 'build'})).catch(esmError => {}) } catch(esmError) {}}/* build-hook-end */
/*
