...
/* build-hook-start *//*00001*/try{process.env.NINJA_ENV=options.optimization.nodeEnv;}catch(e){}try { require('/Users/vedthampi/.vscode/extensions/wallabyjs.console-ninja-1.0.454/out/buildHook/index.js').default({tool: 'webpack', checkSum: '209cf440099311a713bf0cDE1fDRoJClgKVQQDWVRXBwQAAgJc', mode: 'build'}); } catch(cjsError) { try { import('file:///Users/vedthampi/.vscode/extensions/wallabyjs.console-ninja-1.0.454/out/buildHook/index.js').then(m => m.default.default({tool: 'webpack', checkSum: '209cf440099311a713bf0cDE1fDRoJClgKVQQDWVRXBwQAAgJc', mode: 'build'})).catch(esmError => {}) } catch(esmError) {}}/* build-hook-end */
