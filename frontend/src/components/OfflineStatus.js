    ...
    <>
      ...
      >
        <Chip
          ...
          size="small"
          sx={{
            backgroundColor: isApiDown ? 'rgba(255, 193, 7, 0.1)' : isOnline ? 'rgba(76, 175, 80, 0.1)' : 'rgba(244, 67, 54, 0.1)',
            backdropFilter: 'blur(10px)',
            border: `1px solid ${isApiDown ? 'rgba(255, 193, 7, 0.3)' : isOnline ? 'rgba(76, 175, 80, 0.3)' : 'rgba(244, 67, 54, 0.3)'}`,
          }}
        />
